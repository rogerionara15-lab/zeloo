      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
          <div className="lg:col-span-8">
            ...
            <h1 className="text-6xl md:text-[95px] font-black text-slate-950 mb-10 leading-[0.9] tracking-tight">
              <span className="block">Gestão e Manutenção</span>
              <span className="block text-indigo-600">Residencial Sem Complicação.</span>
            </h1>

            <p className="text-xl md:text-2xl text-slate-500 max-w-2xl mb-14 leading-relaxed font-medium">
              Planos por assinatura, atendimento organizado e técnicos qualificados para cuidar do seu lar com padrão e
              responsabilidade.
            </p>
            ...
            <div className="animate-float relative">
              <div className="bg-slate-950 p-10 rounded-[4rem] text-white shadow-[0_50px_100px_-20px_rgba(0,0,0,0.5)] border border-white/10">
                <div className="flex justify-between items-start mb-10">
                  <div className="w-14 h-14 bg-indigo-600 rounded-2xl flex items-center justify-center text-2xl shadow-2xl">
                    🤖
                  </div>
                  {/* (Removido: Status da Casa / 100% Protegida) */}
                </div>
                ...
                <div className="space-y-6">
                  ...
                  <p className="text-[10px] text-slate-400 font-medium leading-relaxed">
                    Próxima manutenção preventiva agendada para: <br />
                    <span className="text-white font-bold">12 de Outubro</span>
                  </p>
                </div>
              </div>

              {/* (Removido: Card flutuante secundário / Resposta Rápida) */}
            </div>
          </div>
        </div>
      </div>
